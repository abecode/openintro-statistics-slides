...
\twocol{0.5}{0.5}{
\begin{center}
\includegraphics[width=\textwidth]{figures/running}
\end{center}
\vspace{-0.5cm}
...
\item Wouldn't it  better to just include everyone and ``sample" the entire population? 
...
\begin{center}
\includegraphics[width=0.90\textwidth]{figures/census_illegal_immig}
\end{center}
...
\item E.g., cooking - you taste (examine) a small part of what you're
  cooking to get an idea about the dish as a whole.

\pause

\item Taste a spoonful of soup and decide the spoonful you tasted isn't salty enough, that's \hl{exploratory analysis}.
...
\begin{itemize}
\item If your spoonful comes from the surface and the salt is at the
  bottom of the pot, it is not representative of the whole pot.
\item If you stir before tasting, your
  spoonful will more likely be representative of the whole pot.
\end{itemize}
...
\begin{center}
\includegraphics[width=0.25\textwidth]{figures/vol_resp_bias/vol_resp_bias_q}\pause
\includegraphics[width=0.25\textwidth]{figures/vol_resp_bias/vol_resp_bias_res} \\
...
\includegraphics[width= \textwidth]{figures/landon_fdr/landon}
...
\includegraphics[width= \textwidth]{figures/landon_fdr/fdr}
...
\includegraphics[width= \textwidth]{figures/literaryDigest}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/sampling_methods/simple}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/sampling_methods/stratified}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/sampling_methods/cluster}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/sampling_methods/multistage}
\end{center}
